...
// workshop held in conjunction with ISCA'2014. // Everyone is granted
// permission to copy, modify, and/or re-distribute        // this software. //
// Please contact Moinuddin Qureshi <moin@gatech.edu> if you have any
// questions//
//                                                                             //
/////////////////////////////////////////////////////////////////////////////////

// --- DO NOT EDIT THIS FILE --- DO NOT EDIT THIS FILE --- DO NOT EDIT THIS FILE
// --- IMPORTANT NOTE: Changing anything in here will violate the competition
// rules.
...
int main(int argc, char *argv[]) {
  ...
  printf("\nMISPRED_PER_1K_INST  \t : %10.3f",
         1000.0 * (double)(numMispred) / (double)(tracer->GetNumInst()));
  printf("\n\n");
}
